// ABOUTME: Phase 1 Integration Tests - End-to-end testing of parser + network + mock server + AppState
...
/// Integration tests for Phase 1 Integration Checkpoint (Issue #20)
///
/// These tests validate all 5 acceptance criteria:
/// 1. Can connect to Lich on localhost:8000
/// 2. Receives XML data from game
/// 3. Parser produces GameTag structures
/// 4. Tags displayed in GameLogView (via GameLogViewModel)
/// 5. No crashes during 5-minute connection
///
/// Architecture tested:
/// ```
...
///                      → AppState (polling + MainActor coordination)
///                      → GameLogViewModel (UI-bound messages)
/// ```
///
/// Performance benchmarks:
/// - Parser throughput: > 10,000 lines/min
/// - Tag processing: < 5ms per 100 tags
/// - Concurrent messages: 10+ scenarios/second without crashes
